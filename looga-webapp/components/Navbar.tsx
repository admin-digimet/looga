...
function NavbarContent() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200 py-3 px-4 md:px-8">
      {mobileSearchOpen ? (
        <div className="flex items-center gap-2 max-w-[1400px] mx-auto lg:hidden">
          <button
            type="button"
          ...
          <form
            ...
            className="flex-1 bg-gray-50 border border-gray-300 rounded-full h-10 flex items-center px-3"
          >
            ...
            <button
              ...
              className="bg-orange text-white rounded-full p-1.5 ml-2 shrink-0"
            >
        ...
        <div className="flex items-center justify-between max-w-[1400px] mx-auto">
          ...
          <div className="flex items-center gap-4 ml-6">
            ...
            {!isAuthenticated && (
              <Link href="/auth/login" className="sm:hidden text-gray-700" aria-label="Compte">
